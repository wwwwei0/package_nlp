...
ictclas.importUserDict('./public/userDict.txt', false);

ictclas.addUserWord('两国关系 user');

ictclas.setTagSet(0);

console.log(ictclas.paragraphProcess(text, 1));

let source = './assets/source.txt';
